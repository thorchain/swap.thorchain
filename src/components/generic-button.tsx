...
const genericButtonVariants = cva(
  'inline-flex items-center justify-center gap-1 rounded-full font-medium whitespace-nowrap shrink-0 cursor-pointer outline-none transition-colors duration-150 ease-out hover:bg-btn-small-hover hover:text-txt-btn-small-hover disabled:bg-btn-small-inactive disabled:text-txt-btn-small-inactive disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      colorType: {
