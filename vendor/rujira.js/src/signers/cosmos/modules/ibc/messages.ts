...
import {
  ...
  MsgTimeout,
  MsgTimeoutOnClose,
} from "../../types/ibc/core/channel/v1/tx";
import {
  MsgCreateClient,
  MsgSubmitMisbehaviour,
  MsgUpdateClient,
  MsgUpgradeClient,
} from "../../types/ibc/core/client/v1/tx";
import {
  MsgConnectionOpenAck,
  MsgConnectionOpenConfirm,
  MsgConnectionOpenInit,
  MsgConnectionOpenTry,
} from "../../types/ibc/core/connection/v1/tx";
...
export function isMsgTransferEncodeObject(
  object: EncodeObject
): object is MsgTransferEncodeObject {
  return (
    (object as MsgTransferEncodeObject).typeUrl ===
