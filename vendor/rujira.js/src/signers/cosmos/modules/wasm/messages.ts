import { EncodeObject, GeneratedType } from "../../proto-signing";
import {
  MsgClearAdmin,
  MsgExecuteContract,
...
export function isMsgStoreCodeEncodeObject(
  object: EncodeObject
): object is MsgStoreCodeEncodeObject {
  return (
    (object as MsgStoreCodeEncodeObject).typeUrl ===
...
export function isMsgInstantiateContractEncodeObject(
  ...
  return (
    (object as MsgInstantiateContractEncodeObject).typeUrl ===
...
export function isMsgInstantiateContract2EncodeObject(
  ...
  return (
    (object as MsgInstantiateContract2EncodeObject).typeUrl ===
...
export function isMsgUpdateAdminEncodeObject(
  object: EncodeObject
): object is MsgUpdateAdminEncodeObject {
  return (
    (object as MsgUpdateAdminEncodeObject).typeUrl ===
...
export function isMsgClearAdminEncodeObject(
  object: EncodeObject
): object is MsgClearAdminEncodeObject {
  return (
    (object as MsgClearAdminEncodeObject).typeUrl ===
...
export function isMsgMigrateEncodeObject(
  object: EncodeObject
): object is MsgMigrateContractEncodeObject {
  return (
    (object as MsgMigrateContractEncodeObject).typeUrl ===
...
export function isMsgExecuteEncodeObject(
  object: EncodeObject
): object is MsgExecuteContractEncodeObject {
  return (
    (object as MsgExecuteContractEncodeObject).typeUrl ===
