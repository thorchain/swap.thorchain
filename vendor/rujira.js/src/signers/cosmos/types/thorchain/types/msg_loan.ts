...
export const MsgLoanOpen = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgLoanOpen {
    const reader =
  ...
  fromJSON(object: any): MsgLoanOpen {
    return {
      ...
      collateralAmount: isSet(object.collateralAmount)
        ? globalThis.String(object.collateralAmount)
        : "",
      targetAddress: isSet(object.targetAddress)
        ? globalThis.String(object.targetAddress)
        : "",
  ...
  fromPartial<I extends Exact<DeepPartial<MsgLoanOpen>, I>>(
    object: I
  ): MsgLoanOpen {
    const message = createBaseMsgLoanOpen();
...
export const MsgLoanRepayment = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgLoanRepayment {
    const reader =
      input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<MsgLoanRepayment>, I>>(
    base?: I
  ): MsgLoanRepayment {
    return MsgLoanRepayment.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgLoanRepayment>, I>>(
    object: I
  ): MsgLoanRepayment {
    const message = createBaseMsgLoanRepayment();
    message.owner = object.owner ?? "";
